...
// To activate the registered user
...
// To Login and generate the token to store in web storage 
...
// Authenticate User from expressJWT when try to login or access the page
